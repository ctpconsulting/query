...
public abstract class AbstractEntityDao<E, PK> implements EntityDao<E, PK> {
    ...
    protected class Criterias {
        ...
        public <P> Criterias eq(SingularAttribute<E, P> att, P value) {
            add(builder.equal(root.get(att), value));
            return this;
        }
        
        public <P> Criterias notEq(SingularAttribute<E, P> att, P value) {
            add(builder.notEqual(root.get(att), value));
            return this;
        }
        
        public <P> Criterias like(SingularAttribute<E, String> att, String value) {
            add(builder.like(root.get(att), value));
            return this;
        }
        
        public <P> Criterias notLike(SingularAttribute<E, String> att, String value) {
            add(builder.notLike(root.get(att), value));
            return this;
        }
        
        public <P extends Number> Criterias lt(SingularAttribute<E, P> att, P value) {
            add(builder.lt(root.get(att), value));
            return this;
        }
        
        public <P extends Comparable<? super P>> Criterias ltOrEq(SingularAttribute<E, P> att, P value) {
            add(builder.lessThanOrEqualTo(root.get(att), value));
            return this;
        }
        
        public <P extends Number> Criterias gt(SingularAttribute<E, P> att, P value) {
            add(builder.gt(root.get(att), value));
            return this;
        }
        
        public <P extends Comparable<? super P>> Criterias gtOrEq(SingularAttribute<E, P> att, P value) {
            add(builder.greaterThanOrEqualTo(root.get(att), value));
            return this;
        }
        
        public <P extends Comparable<? super P>> Criterias between(SingularAttribute<E, P> att, P lower, P upper) {
            add(builder.between(root.get(att), lower, upper));
            return this;
        }
        
        public <P> Criterias isNull(SingularAttribute<E, P> att) {
            add(builder.isNull(root.get(att)));
            return this;
        }
        
        public <P> Criterias notNull(SingularAttribute<E, P> att) {
            add(builder.isNotNull(root.get(att)));
            return this;
        }
        
        public <P extends Collection<?>> Criterias empty(SingularAttribute<E, P> att) {
            add(builder.isEmpty(root.get(att)));
            return this;
        }
        
        public <P extends Collection<?>> Criterias notEmpty(SingularAttribute<E, P> att) {
